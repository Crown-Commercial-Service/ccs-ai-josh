...
### Document URLs
To link to the documents that an answer is based on, we use a table of file names and URLs that is updated regularly to reflect the latest documents that are available. For full instructions on how to create this table, see the internal documentation.
